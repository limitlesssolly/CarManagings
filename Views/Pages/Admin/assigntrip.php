                ...
                <div class="container" >
                    ...
                    <form action="" method="post">
                        ...
                        <label for="fullname">Trip ID</label>
                            <input type="text" class="field" name="tripid" placeholder="samy salama" required> <br>
                        </div>  
                        <div class="name">
                        ...
                        <div class="contactinfo">
                            <label for="contactnumbers">Driver Photo</label>
                            <input type="file" class="field" name="photo" placeholder="mail@gmail.com" required> 
                        </div>
                        ...
                        <div class="contactinfo">
                            <label for="contactnumbers">Car Photo</label>
                            <input type="file" class="field" name="photo" placeholder="mail@gmail.com" required> 
                        </div>
